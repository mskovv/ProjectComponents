<?php $this->layout('layout', ['title' => 'Create User'])?>
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="/ProjectComponents/public/createUser" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                    <div id="panel-1" class="panel">
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <!-- contact email -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Contact email</label>
                                    <input type="text" id="simpleinput" class="form-control" name="contactEmail">
                                </div>
                            </div>
                        </div>
